 ...
 */
etcd_node_t *etcd_get (etcd_session session, char *key);
...
etcd_node_t *etcd_watch (etcd_session session, char *pfx, int *index_in);
...
etcd_result etcd_set_dir(etcd_session session, char *key, unsigned int ttl);    
